Here are some user groups based in Canada:

-Open Worldwide Application Security Project User group (OWASP) - Ottawa chapter:

https://github.com/OWASP/www-chapter-ottawa

-Open Source Nerds and Nachos: 

https://www.meetup.com/opensourcenerdsandnachos/

-Ottawa Capital Linux User Group:

linux@linux-ottawa.org

-Ottawa BSD User Group:

ocbug@ocbug.ca

-Low Level Linux User Group (L3GO):

sigs-l3go@linux-ottawa.org
